...
use App\Models\TimeThree;
use Firebase\JWT\JWT;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Hash;

class TimeThreeController extends Controller
{
    /**
...
//MOSTRAR TODOS--------------------------
    public function showAllTimeThrees()
    {
        return response()->json(TimeThree::all()); //retorna serviços do banco
    }
//CADASTRAR------------------------------  
    public function createTimeThree(Request $request)
    {
        //validacao
...
//MOSTRAR UM -------------------------
    public function readTimeThree($id)
    {
        return response()->json(TimeThree::find($id));
    }
//ATUALIZAR ----------------------------
    public function updateTimeThree($id, Request $request)
    {
        $time = TimeThree::find($id);
...
//DELETAR --------------------------
    public function deleteTimeThree($id)
    {
        $time = TimeThree::find($id);

        $time->delete();
        return response()->json('TimeThree Deletado com Sucesso', 200);
    }
    //-----------------------------------
}